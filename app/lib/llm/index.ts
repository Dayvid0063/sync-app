 ...
 *
 * History: a wllama (llama.cpp) engine was tried on 2026-09-24 and removed — on iPhone it
 * crashed while starting in both GPU and CPU mode, whereas this engine loads and chats.
 */
